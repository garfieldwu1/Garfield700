...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  let getImage = (
    await axios.get(encodeURI(`https://i.imgur.com/fwhCZy7.jpg`), {
...
if(!fs.existsSync(__dirname+'/cache/SVN-Arial 2.ttf')) { 
  ...
  const line = await this.wrapText(ctx, text[0], 350);
  const lines = await this.wrapText(ctx, text[1], 450);
