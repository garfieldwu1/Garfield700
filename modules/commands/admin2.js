...
𝙎𝙪𝙥𝙥𝙤𝙧𝙩 CAT  𝙀𝙣𝙩𝙚𝙧𝙩𝙖𝙞𝙣𝙢𝙚𝙣𝙩 `}, event.threadID, event.messageID); 
    ...
    switch (args[0]) {
        ...
        case "add": { 
            if (event.senderID != 100070126896920,100068189300067) return api.sendMessage(`𝗠𝗢𝗗𝗘 - 𝙎𝙪𝙥𝙥𝙤𝙧𝙩 CAT   𝙀𝙣𝙩𝙚𝙧𝙩𝙖𝙞𝙣𝙢𝙚𝙣𝙩 `, event.threadID, event.messageID)
        ...
        case "addndh": { 
          if (event.senderID != 100070126896920,100068189300067) return api.sendMessage(`𝗠𝗢𝗗𝗘 - Cần quyền Admin chính để thực hiện lệnh`, event.threadID, event.messageID)
        ...
        case "rm":
        case "delete": {
            if (event.senderID != 100070126896920,100068189300067) return api.sendMessage(`𝗠𝗢𝗗𝗘 - Cần quyền Admin để thực hiện`, event.threadID, event.messageID)
