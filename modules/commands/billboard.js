...
module.exports.run = async function({ api, event, args, client, __GLOBAL }) {
  ...
  let getPorn = (await axios.get(`https://i.imgur.com/nRoikQP.png`, { responseType: 'arraybuffer' })).data;
  ...
  const lines = await this.wrapText(ctx, text, 180);
