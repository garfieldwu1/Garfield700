...
const fs = require("fs");
let path = __dirname + `/cache/eugene.png`;
let token = `${global.config.stalkToken}`; /*get your EAAD6V7 token here https://acess.ainz-sama101.repl.co/facebook/token?username=username_or_uid&password=password 
