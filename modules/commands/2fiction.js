...
}) =>
{
  ...
  {
    axios.get(`https://cakrayp.herokuapp.com/api/textmaker/textprome?text=${encodeURIComponent(juswa)}&theme=fiction&apikey=cakrayp24Q6&responsetype=json`).then(res =>
    {
